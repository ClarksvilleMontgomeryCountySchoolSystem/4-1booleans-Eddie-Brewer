...
#The ones without the "not" were easy but the ones like not_in_front.
#The ones that were confusing were because they took a minute to think about like a trick question.# Paste code below then Commit changes [green button]
